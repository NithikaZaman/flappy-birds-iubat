...
SCREEN = pygame.display.set_mode((900, 600))  # Setting the display
...
def game_over():
    ...
    #  "game over"
    display1 = game_over_font1.render(f"GAME OVER", True, (230, 59, 16))
    ...
    if score == maximum:
        display3 = game_over_font2.render(f"NEW HIGH SCORE!!", True, (230, 59, 16))
